...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '15651605402080c39da5c2b12ba4f922,en:7c1d570661754c8fbc568e00a01fd70e',
  ...
  GREETING_WORDS:
    ...
    'Hi，我是一个大学生, Hi，我是一个打工人,Hi，我是一个干饭人,欢迎来到我的博客🎉',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '第二十二条老头衫', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '来回蹦哒蹦哒', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://notion-next-coral-three-21.vercel.app/', // 网站地址
